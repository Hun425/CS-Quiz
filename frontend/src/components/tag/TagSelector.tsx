    ...
    useEffect(() => {
        if (searchTerm.trim()) {
            const filtered = allTags.filter(tag =>
                ...
                (tag.synonyms && Array.from(tag.synonyms).some(synonym =>
                ...
                {isDropdownOpen && (
                    ...
                    >
                        {loading ? (
                            ...
                            <div style={{ padding: '0.5rem', textAlign: 'center', color: '#d32f2f' }}>
                                {error}
                            </div>
                            ...
                            filteredTags.map(tag => (
                                <div
                                    ...
                                    style={{
                                        padding: '0.5rem',
                                        cursor: 'pointer',
                                        backgroundColor: selectedTagIds.includes(tag.id) ? '#e3f2fd' : 'white',
                                ...
                                >
                                    <div>
                                        <span style={{ fontWeight: selectedTagIds.includes(tag.id) ? 'bold' : 'normal' }}>
                                            {tag.name}
                                        </span>
                                        {tag.description && (
