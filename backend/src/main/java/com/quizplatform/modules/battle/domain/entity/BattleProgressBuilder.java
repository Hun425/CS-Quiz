...
public class BattleProgressBuilder {
     ...
     * 진행 상황을 빌드할 배틀 방
     */
    private final com.quizplatform.core.domain.battle.BattleRoom battleRoom;
    ...
    public BattleProgress build() {
        ...
        for (com.quizplatform.core.domain.battle.BattleParticipant participant : battleRoom.getParticipants()) {
     ...
     */
    private ParticipantProgress createParticipantProgress(com.quizplatform.core.domain.battle.BattleParticipant participant) {
     ...
     */
    private int getCurrentQuestionPoints(com.quizplatform.core.domain.battle.BattleRoom battleRoom) {
