package com.quizplatform.common.adapter.config;
...
public class SwaggerConfig {
    ...
    // TODO: 이 redirectUri 값이 여전히 필요한지, common 모듈에서 관리하는 것이 맞는지 확인 필요
    @Value("${app.oauth2.authorized-redirect-uri:#{null}}") 
