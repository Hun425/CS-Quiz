...
public class QUserLevel extends EntityPathBase<UserLevel> {
    ...
    private static final long serialVersionUID = 1139199765L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QUserLevel userLevel = new QUserLevel("userLevel");

    public final SetPath<Achievement, EnumPath<Achievement>> achievements = this.<Achievement, EnumPath<Achievement>>createSet("achievements", Achievement.class, EnumPath.class, PathInits.DIRECT2);
