...
public class QUserAchievementHistory extends EntityPathBase<UserAchievementHistory> {
    ...
    private static final long serialVersionUID = -2108193313L;
    ...
    public final EnumPath<com.quizplatform.core.domain.quiz.Achievement> achievement = createEnum("achievement", com.quizplatform.core.domain.quiz.Achievement.class);
