...
public class Question {
    ...
    /**
     * 문제 표시 순서를 반환합니다. (ID 기반으로 대체)
     */
    public int getDisplayOrder() {
        return id != null ? id.intValue() % 1000 : 0;
    }
    
    /**
     * 정답 ID 목록을 반환합니다. (단일 정답의 경우 리스트로 변환)
     */
    public List<String> getCorrectAnswerIds() {
    ...
    public static class AnswerOption {
        ...
        @Builder
        public AnswerOption(Long id, String optionText, int displayOrder) {
            this.id = id;
