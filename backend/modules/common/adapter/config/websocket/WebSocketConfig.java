...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
     ...
     * STOMP 채널 인터셉터
     */
    // StompChannelInterceptor 는 같은 패키지 내에 위치
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/ws-battle") // TODO: 엔드포인트 경로 일반화 고려
                .setAllowedOrigins("http://localhost:5173", "http://localhost:3000") // TODO: 허용 오리진 설정 분리 고려 (예: application.yml)
                .addInterceptors(new HttpSessionHandshakeInterceptor()) // HTTP 세션 정보 WebSocket 세션에 복사
                .withSockJS()
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        // TODO: StompChannelInterceptor 위치 확인
