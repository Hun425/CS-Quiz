...
public class User {
    ...
    private List<UserLevelHistory> levelHistories = new ArrayList<>();
    ...
    protected void onCreate() {
        ...
        if (this.battleStats == null) {
            this.battleStats = new UserBattleStats(this);
        }
    }
