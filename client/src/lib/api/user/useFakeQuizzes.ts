...
const dummyQuizzes: QuizSummaryResponse[] = [
  {
    id: 1,
    title: "자료구조 기초 퀴즈",
    quizType: "MULTIPLE_CHOICE" as QuizType,
    difficultyLevel: "EASY" as QuizDifficultyType,
    questionCount: 10,
    attemptCount: 132,
    avgScore: 7.2,
    tags: [
  ...
  },
  {
    id: 2,
    title: "네트워크 심화 문제집",
    quizType: "SHORT_ANSWER" as QuizType,
    difficultyLevel: "HARD" as QuizDifficultyType,
    questionCount: 15,
    attemptCount: 88,
    avgScore: 5.4,
    tags: [
