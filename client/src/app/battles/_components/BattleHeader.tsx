...
const BattleHeader: React.FC<Props> = ({ battleRoom }) => {
  return (
    <div className="space-y-2">
      <header
        className="bg-primary text-white px-6 py-4 rounded-xl  flex flex-col sm:flex-row sm:items-center sm:justify-between"
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 px-4 py-3 rounded-md shadow-sm">
        <p className="text-sm font-medium">
          ...
          <strong className="text-yellow-900"> 5초 후 자동으로 시작</strong>
          됩니다.
        </p>
